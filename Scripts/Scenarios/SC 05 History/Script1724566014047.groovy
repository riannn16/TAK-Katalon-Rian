...
WebUI.callTestCase(findTestCase('Blocks/Appointment Positive'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Blocks/History'), [:], FailureHandling.STOP_ON_FAILURE)
