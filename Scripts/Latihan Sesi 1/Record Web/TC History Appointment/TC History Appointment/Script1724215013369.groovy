...
WebUI.click(findTestObject('Object Repository/Spy Web Latihan 1/History Page/a_menu-toggle'))

WebUI.delay(3)

WebUI.click(findTestObject('Object Repository/Spy Web Latihan 1/History Page/a_history'))
