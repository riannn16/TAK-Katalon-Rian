...
WebUI.setEncryptedText(findTestObject('Record Web Exercise 1 dan 2/Page_Login/input_password'), 'NhbHzDFXUPA=')

WebUI.delay(2)

WebUI.click(findTestObject('Object Repository/Record Web Exercise 1 dan 2/Page_Login/button_login'))

WebUI.click(findTestObject('Record Web Exercise 1 dan 2/Page_Login/failed_login'))
