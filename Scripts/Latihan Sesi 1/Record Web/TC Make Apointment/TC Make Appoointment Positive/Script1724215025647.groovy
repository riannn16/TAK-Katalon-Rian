...
WebUI.selectOptionByValue(findTestObject('Spy Web Latihan 1/Appoinment Page/slct_Tokyo-Hongkong-Seoul'), 'Hongkong CURA Healthcare Center', 
    true)

WebUI.click(findTestObject('Spy Web Latihan 1/Appoinment Page/lbl_readmission'))

WebUI.click(findTestObject('Spy Web Latihan 1/Appoinment Page/label_healthcare-program'))

WebUI.click(findTestObject('Spy Web Latihan 1/Appoinment Page/input_visit_date'))

WebUI.click(findTestObject('Spy Web Latihan 1/Appoinment Page/lbl_comment'))
